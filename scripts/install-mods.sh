#!/usr/bin/env bash
# -----------------------------------------------
# Coffees Aero SMP — Packwiz Mod Installer (Linux/macOS)
# -----------------------------------------------
...
echo ""
echo "Done! Run 'packwiz modrinth export' to build the .mrpack"
echo "      Run 'packwiz curseforge export' to build the CurseForge .zip"
